  ...
  <v-layout align-start>
      <v-flex>
        ...
        >
            <template v-slot:top>
              <v-toolbar flat >
                <v-toolbar-title><h4> Emprendedor</h4></v-toolbar-title>
                <v-divider
                    class="mx-4"
                    inset
                    vertical
                ></v-divider>
                <v-spacer></v-spacer>
                <v-text-field  class="text-xs-center" v-model="search" append-icon=""
                            ...
                            >
                              ...
                              >
                                <v-select
                                  ...
                                  :items="itemsGenero"
                                  label="Género (M)asculino (F)emenino"
                                ></v-select>
                              </v-col>
                            <v-col
                              cols="12"
                ...
                <v-dialog v-model="dialogDelete" max-width="500px">
                    <v-card>
                      <v-card-title class="text-h6">esta seguro que desea eliminar este item?</v-card-title>
                      <v-card-actions>
                        <v-spacer></v-spacer>
